  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final homeRetrievePostsForTagsResponse = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
                                ...
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    ...
                                    image: CachedNetworkImageProvider(
                                      RetrieveImageURLsForPostCall.picURL(
                                        gradientRetrieveImageURLsForPostResponse
                                            .jsonBody,
                                      ),
                                    ),
                                  ),
                                              ...
                                              children: [
                                                AutoSizeText(
                                                  RetrievePostsForTagsCall
                                                      .latestPostTitle(
                                                    homeRetrievePostsForTagsResponse
                                                        .jsonBody,
                                                  ).toString(),
                                        ...
                                        return Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  16, 8, 0, 8),
                                          child: FutureBuilder<ApiCallResponse>(
                                            future: RetrieveImageURLsForPostCall
                                                .call(
                                              postid: getJsonField(
                                                postsCarsItem,
                                                r'''$.featured_media''',
